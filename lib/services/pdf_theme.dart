...
class PdfThemes {
  ...
  /// 5. ಕಪ್ಪು-ಬಿಳಿ — Black & White
  static const blackWhite = PdfThemeConfig(
    id: 'black_white',
    nameKn: 'ಕಪ್ಪು-ಬಿಳಿ',
    nameEn: 'Black & White',
    icon: Icons.star,
    ...
    sectionTitleBg: Color(0xFF333333),
    sectionTitleText: Color(0xFFFFFFFF),
    tableHeaderBg: Color(0xFF1A1A1A),
    tableHeaderText: Color(0xFFFFFFFF),
    tableAltRow: Color(0xFFF0F0F0),
    pageBg: Color(0xFFFFFFFF),
    detailBoxBg: Color(0xFFF5F5F5),
    detailBorder: Color(0xFF555555),
    shlokaText: Color(0xFF333333),
    footerText: Color(0xFF1A1A1A),
    chartCenterBg: Color(0xFFF0F0F0),
    chartCenterText: Color(0xFF1A1A1A),
    chartBorder: Color(0xFF555555),
    dashaHighlight: Color(0xFFF0F0F0),
    dashaHighlightBorder: Color(0xFF555555),
    dashaHighlightText: Color(0xFF1A1A1A),
    dashaAltRow: Color(0xFFF0F0F0),
    borderColor1: Color(0xFF1A1A1A),
    borderColor2: Color(0xFF555555),
    borderWidth1: 3.5,
    borderWidth2: 2.0,
    borderInset: 5.0,
    hasCornerOrnaments: true,
    cornerColor: Color(0xFF555555),
  );
